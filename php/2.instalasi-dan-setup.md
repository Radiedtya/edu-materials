...
// Ini adalah komentar satu baris -> shortcut: CTRL + /

/*
   Ini adalah komentar
   beberapa baris                 -> shortcut: Alt + Shift + A
*/
...
*Kalau semua checklist di atas sudah dicentang, kamu siap lanjut ke materi berikutnya: **Sintaks Dasar PHP**.*
